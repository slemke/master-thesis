...
from preprocessing.file import get_code_snippets
...
FILES = [
    '../../data/methods/clean.txt',
    '../../data/methods/not_clean.txt'
]

# get documents and labels
docs, labels = get_code_snippets(FILES)
...
# fit the model
model.fit(x_train, y_train, validation_split=0.5, epochs=3, batch_size=64)
